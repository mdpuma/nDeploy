...
if os.path.isfile(backend_config_file):
    ...
    if "PHP" in backend_data_yaml_parsed and os.path.isfile(installation_path+"/user-data/"+cpaneluser) and os.path.isfile(installation_path+"/conf/templates/user_data.yaml"):
